...
public class UserCanBuyProductsTest extends TestBase {
    ...
    @Test(description = "User can buy product")
    public void userCanBuyProducts() {
        ...
        Assert.assertEquals(actualProducts, addedProducts, Arrays.toString(actualProducts) + "not equals " + Arrays.toString(addedProducts));
