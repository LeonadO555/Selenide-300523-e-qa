...
public class UserCanBuyProductsTest extends TestBase{
    ...
    public void userCanBuyProducts() {
        ...
        String productsRemoveToProductPage = String.valueOf(productNames[0]);
        productsPage.openProductPage(productsRemoveToProductPage);

        productPage = new ProductPage();
        productPage.clickRemoveFromCart(productsRemoveToProductPage);
